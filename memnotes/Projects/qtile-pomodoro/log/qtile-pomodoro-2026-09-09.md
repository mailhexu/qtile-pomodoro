...
- Deployed temporary queryable BreakOverlays diagnostics for the group-2 hidden-overlay report. The current snapshot is read over Qtile IPC; awaiting a user-captured failing transition.
